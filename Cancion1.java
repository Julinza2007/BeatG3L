    ...
    protected void construirCancion(ResolucionManager resolucion) {
    	...
    	SwingUtilities.invokeLater(() -> {
    		SwingUtilities.invokeLater(() -> {
    			...
    			Nota nota1 = new Nota(posX_D + resolucion.escalarX(80), 100, Color.RED, resolucion); // posición inicial y color
    			panelJuego.add(nota1); // Agrega la nota al fondo
    			this.notas.add(nota1);
    			super.agregarNota(nota1);
    			
    			Nota nota2 = new Nota(posX_F + resolucion.escalarX(80), 100, Color.YELLOW, resolucion); // posición inicial y color
    			panelJuego.add(nota2); // Agrega la nota al fondo
    			this.notas.add(nota2);
    			super.agregarNota(nota2);
    			
    			Nota nota3 = new Nota(posX_J + resolucion.escalarX(80), 100, Color.MAGENTA, resolucion); // posición inicial y color
    			panelJuego.add(nota3); // Agrega la nota al fondo
    			this.notas.add(nota3);
    			super.agregarNota(nota3);
    			
    			Nota nota4 = new Nota(posX_K + resolucion.escalarX(80), 100, Color.GREEN, resolucion); // posición inicial y color
