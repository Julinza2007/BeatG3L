...
public class dialogos5 extends JPanel implements ActionListener {
    ...
    public dialogos5(JFrame ventana, ResolucionManager resolucion) {
    ...
    private void cargarDialogos() {
    	imagenes.add(new ImageIcon("src/img/fernandoDialogo5.jpg"));
    }
