...
public class dialogos6 extends JPanel implements ActionListener {
    ...
    public dialogos6(JFrame ventana, ResolucionManager resolucion) {
    ...
    private void cargarDialogos() {
    	imagenes.add(new ImageIcon("src/img/lucasDialogo4.jpg"));
    }
