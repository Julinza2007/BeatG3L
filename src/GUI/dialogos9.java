...
public class dialogos9 extends JPanel implements ActionListener {
    ...
    public dialogos9(JFrame ventana, ResolucionManager resolucion) {
    ...
    private void cargarDialogos() {
    	imagenes.add(new ImageIcon("src/img/lucasDialogo6.jpg"));
    	imagenes.add(new ImageIcon("src/img/lucasDialogo7.jpg"));
    	imagenes.add(new ImageIcon("src/img/nicolasDialogo4.jpg"));
    }
