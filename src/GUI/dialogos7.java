...
public class dialogos7 extends JPanel implements ActionListener {
    ...
    public dialogos7(JFrame ventana, ResolucionManager resolucion) {
    ...
    private void cargarDialogos() {
    	imagenes.add(new ImageIcon("src/img/fernandoDialogo6.jpg"));
    }
