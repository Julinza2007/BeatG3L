...
public class dialogos8 extends JPanel implements ActionListener {
    ...
    public dialogos8(JFrame ventana, ResolucionManager resolucion) {
    ...
    private void cargarDialogos() {
    	imagenes.add(new ImageIcon("src/img/lucasDialogo5.jpg"));
    }
